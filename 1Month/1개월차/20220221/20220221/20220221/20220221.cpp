...
#pragma region 시프트 연산자
	...
	// 왼쪽 시프트 연산의 경우 2의 n제곱만큼 곱하기 연산을 수행하며, 오버플로우가 발생하지 않도록 유의해야한다.
	// 오른쪽 시프트 연산의 경우 2의n제곱만큼 나누기 연산을 수행한다.
	/*
...
#pragma region 삼항 연산자
	...
	// 간단한 조건을 이용하여 값을 도출하고자 할 때 또는 단순 조건식을 해결하고자 할 때 많이 사용한다.
	/*
	int iNum = 10;
	int iNum2 = 20;
	int iResult = 0;
